...
public class AirportJDBC implements GestionAirport{
	...
	public void ajouterAirport(Airport e) {
		try {
			PreparedStatement ps=connection.prepareStatement("insert into airport (airportCode,airportName,country) values(?,?,?)");
	...
	/*@Override
	/*public List<Airport> rechercherParMC(String mc) {
